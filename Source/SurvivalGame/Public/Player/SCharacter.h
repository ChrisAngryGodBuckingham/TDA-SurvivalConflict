...
private:
	...
	UPROPERTY(EditAnywhere, Blueprintable, Category = "Camera")
...
*/
	...
	UPROPERTY(EditAnywhere,BluePrintReadWrite, Category = "Mesh | Clothing")
...
public:
	...
	/************************************/
protected:
	UPROPERTY(BlueprintReadOnly, Category = "HideinShadows")
	bool bIsInAnyLight;
};
